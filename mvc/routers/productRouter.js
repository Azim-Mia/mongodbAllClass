const {createProduct,handleGetSingleProduct,handleSingleProductDelete,handleUpdateSingleProduct,
  handleGetAllProduct
}=require('/data/data/com.termux/files/home/mongodbAllClass/mvc/controllers/productController.js');
...
const {upload}=require('/data/data/com.termux/files/home/mongodbAllClass/middleware/fileUpload.js');
